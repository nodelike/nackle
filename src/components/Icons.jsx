...
export function NackleLogo({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="80 68 360 368" fill="none" style={{ display: "block" }}>
      ...
      {/* Back face */}
      <path d="M 128,392 L 128,96 L 204,96 L 204,256 L 340,96 L 416,96 L 416,392 L 340,392 L 340,232 L 204,392 Z"
        fill="currentColor" fillOpacity="0.04" stroke="currentColor" strokeWidth="0.8" strokeLinejoin="miter" strokeOpacity="0.2"/>
      {/* Extrusion top faces */}
      ...
      {/* Bottom + left edges */}
      <polygon points="112,408 188,408 204,392 128,392" fill="currentColor" fillOpacity="0.03" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1"/>
      <polygon points="324,408 400,408 416,392 340,392" fill="currentColor" fillOpacity="0.03" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1"/>
      <polygon points="112,112 112,408 128,392 128,96" fill="currentColor" fillOpacity="0.02" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.08"/>
      <polygon points="324,248 188,408 204,392 340,232" fill="currentColor" fillOpacity="0.02" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.08"/>
      {/* Front face */}
      <path d="M 112,408 L 112,112 L 188,112 L 188,272 L 324,112 L 400,112 L 400,408 L 324,408 L 324,248 L 188,408 Z"
      ...
      <path d="M 112,408 L 112,112 L 188,112 L 188,272 L 324,112 L 400,112 L 400,408 L 324,408 L 324,248 L 188,408 Z"
        fill="none" stroke="currentColor" strokeWidth="3" strokeLinejoin="miter" filter="url(#nl-glow)"/>
      {/* Inner wireframe */}
      <path d="M 130,390 L 130,130 L 176,130 L 176,308 L 336,130 L 382,130 L 382,390 L 336,390 L 336,212 L 176,390 Z"
        fill="none" stroke="currentColor" strokeWidth="0.8" strokeLinejoin="miter" opacity="0.25"/>
      {/* Structure lines */}
