  ...
  return (
    <div style={st.container}>
      ...
      <div style={st.themeGrid}>
        {Object.entries(themes).map(([key, t]) => {
          ...
          return (
            <div
              key={key}
              style={{ ...st.themeCard, ...(isActive ? st.themeCardActive : {}) }}
            ...
            >
              ...
              <span style={{ ...st.themeName, ...(isActive ? st.themeNameActive : {}) }}>
                {t.name}
              </span>
            </div>
          );
      ...
      <div style={st.row}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <Slider
            ...
            step={0.05}
            value={bgOpacity}
            onChange={(v) => save("background-opacity", String(v))}
          />
      ...
      <div style={st.row}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <Slider
            ...
            step={1}
            value={bgBlurRadius}
            onChange={(v) => save("background-blur-radius", String(v))}
          />
      ...
      <div style={st.dangerSection}>
        ...
        <div style={st.dangerHint}>
          Permanently delete all collections, todos, and archived items. Settings are preserved.
        </div>
        <button
        ...
        <div style={st.confirmOverlay} onClick={() => setConfirmWipe(false)}>
          <div style={st.confirmBox} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={st.confirmText}>
              This will permanently delete all your collections, todos, and archived items.
              Only Inbox and settings will remain. This cannot be undone.
            </div>
