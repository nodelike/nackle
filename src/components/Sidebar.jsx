    ...
    return (
        <div
            ...
            <div style={{ ...S.sidebarHeader, justifyContent: "center" }}>
                <span style={{ ...S.logo, color: "var(--accent)", display: "flex", alignItems: "center" }}>
                    <NackleLogo size={20} />
                </span>
                ...
                <div
                    ...
                    <span
                        style={{
                            ...
                            color: isArchive ? "var(--accent)" : "var(--fg-muted)",
                        }}>
                        <ArchiveIcon size={12} strokeWidth={2} />
                    </span>
                    <span style={{ ...S.collectionName, ...(isArchive ? { color: "var(--accent)" } : {}) }}>Archive</span>
                    {archiveCount > 0 && (
                        <span style={{ ...S.badge, ...(isArchive ? { color: "var(--accent)", opacity: 0.7 } : {}) }}>{archiveCount}</span>
                    )}
                </div>
            </div>
                    ...
                    {collections.map((col) => {
                        ...
                        return (
                            <div
                                ...
                                {count > 0 && (
                                    <span style={{ ...S.badge, ...(isActive ? { color: "var(--accent)", opacity: 0.7 } : {}) }}>{count}</span>
                                )}
            ...
            <div style={{ borderTop: "1px solid var(--border)", paddingTop: 12, display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                <div
                    ...
                    <span style={{ color: "var(--accent)", opacity: 0.5 }}>
                        {allCount} <span style={{ opacity: 0.7 }}>open</span>
                    </span>
                    <span style={{ color: "var(--accent-secondary)", opacity: 0.4 }}>
                        {doneCount} <span style={{ opacity: 0.7 }}>done</span>
                    </span>
                    <span style={{ color: "var(--fg-muted)", opacity: 0.35 }}>
                        {collections.length} <span style={{ opacity: 0.7 }}>lists</span>
                    </span>
                </div>
                ...
                <div
                    ...
                    <span
                        style={{
                            ...
                            alignItems: "center",
                            justifyContent: "center",
                            color: isSettings ? "var(--accent)" : "var(--fg-muted)",
                        }}>
                    ...
                    <span style={{ ...S.shortcutKey, marginLeft: "auto" }}>
                        {isMac ? (
                            <span style={{ fontSize: 13, verticalAlign: "-1px", position: "relative", top: 0.5 }}>{"\u2318"}</span>
                        ) : (
                            <span>Ctrl+</span>
                        )}
                        ,
